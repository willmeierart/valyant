export default [
  {
    color: 'red',
    isFirstView: true,
    imageUrl: 'https://s3.us-east-2.amazonaws.com/valyant/splash/1.jpg',
  ...
  {
    color: 'orange',
    imageUrl: 'https://s3.us-east-2.amazonaws.com/valyant/splash/2.jpg',
  ...
  {
    color: 'yellow',
    imageUrl: 'https://s3.us-east-2.amazonaws.com/valyant/splash/3.jpg',
  ...
  {
    color: 'green',
    imageUrl: 'https://s3.us-east-2.amazonaws.com/valyant/splash/4.jpg',
  ...
  {
    color: 'blue',
    imageUrl: 'https://s3.us-east-2.amazonaws.com/valyant/splash/5.jpg',
    headerCopy: 'There when you need them',
    bodyCopy: "Church-key retro try-hard XOXO. Waistcoat godard woke jean shorts iPhone. Twee kinfolk gochujang food truck brooklyn shaman cred meh raw denim pitchfork schlitz four loko beard roof party 90's. Pour-over chicharrones vaporware affogato cornhole."
  },
  {
    color: 'purple',
    imageUrl: 'https://s3.us-east-2.amazonaws.com/valyant/splash/6.jpg',
    headerCopy: 'Super Powers',
    bodyCopy: "Pork belly seitan heirloom, echo park kale chips blue bottle palo santo hoodie kickstarter paleo sartorial ramps polaroid banh mi. Mumblecore kale chips heirloom kitsch live-edge, messenger bag bicycle rights everyday carry literally cray crucifix wolf pork belly copper mug paleo. Humblebrag blue bottle dreamcatcher banjo fashion axe whatever actually migas iPhone chicharrones meh vexillologist lyft. Subway tile ramps squid kombucha, austin brooklyn tacos hella. Yuccie craft beer franzen messenger bag, helvetica pork belly art party lomo ugh blue bottle wayfarers. Gochujang mixtape seitan, glossier four dollar toast semiotics yr fixie butcher 90's tote bag master cleanse. Crucifix direct trade poke food truck snackwave trust fund godard."
  },
  {
    color: 'black',
    isLastView: true,
    imageUrl: 'https://s3.us-east-2.amazonaws.com/valyant/splash/7.jpg',
